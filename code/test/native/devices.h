...
private:
    ...
    static inline std::map<std::string, std::list<DevicesClass::Device>
            ::iterator > _devices_map;
    static inline std::map<std::string, std::list<DevicesClass::Room>
            ::iterator> _rooms_map;
    static inline std::map<std::string, std::list<DevicesClass::
            Mainswitch>::iterator> _mainswitches_map;
    static inline std::map<std::string, std::list<DevicesClass::Mux>
            ::iterator> _muxes_map;   
...
private:
    ...
    static inline std::array<Accumulated_Readings,2> _acc_readings 
            {Accumulated_Readings{60  , 0},
             Accumulated_Readings{1800, 0}   };
...
public:
    ...
    Mainswitch(std::string name):_name(name){}
    Iterator begin(){
        return {_devices_list.begin()};
    }
    Iterator end(){
